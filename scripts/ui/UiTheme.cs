...
public static class UiTheme
{
    public static class Palette
    {
        ...
        // Card type fills/borders (moved out of CardView.FrameStyle)
        public static readonly Color AttackFill = new(0.32f, 0.13f, 0.13f);
        public static readonly Color AttackBorder = new(0.65f, 0.32f, 0.28f);
        public static readonly Color AttackBorderHover = new(0.95f, 0.55f, 0.35f);
        public static readonly Color SkillFill = new(0.12f, 0.26f, 0.22f);
        public static readonly Color SkillBorder = new(0.3f, 0.55f, 0.45f);
        public static readonly Color SkillBorderHover = new(0.5f, 0.85f, 0.7f);
        ...
        // Rarity (new dimension, additive alongside CardType)
