...
// _GuiInput) - LibraryScreen's relic/potion tiles are PanelContainers with
// no input handling of their own, so BuildFocusableFrame has nothing to
// wire a click to without this.
